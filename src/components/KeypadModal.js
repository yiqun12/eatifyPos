...
function KeypadModal({
  ...
  return (
    ...
    >
      <div className="modal-dialog" role="document" style={{ maxWidth: width, width: width }}>
        <div className="modal-content">
          ...
          <div className="modal-body">
            <div className="row" style={{ display: 'flex' }}>
              ...
              <div className={`col-md-${isPC && showNumberPad && showQuickAmounts ? '6' : (isPC && (showNumberPad || showQuickAmounts) ? '9' : '12')}`}>
                {children}
              </div>
