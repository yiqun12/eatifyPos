    ...
    <div className=''>
      <div style={{ maxHeight: `calc(100vh - 50px)`, overflowY: 'auto' }}>
        <section class="bg-gray-100 py-12" id="about">
          <div class="container mx-auto px-4 max-w-screen-lg">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div class="text-left">
                <h1 class="text-4xl font-semibold mb-4 text-gray-800">
                ...
                <p class="text-gray-600 leading-relaxed mb-6">
                  18 restaurants like yours trust 7dollar.delivery with their technology.
                  From POS to Delivery & takeout, we take care of it all – so you can focus on what you do best.
                </p>
                <div class="flex space-x-4">
                  <button
                    class="px-4 py-2 bg-green-600 text-white text-base font-medium rounded-lg shadow-md hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-300 transform active:scale-95 transition-all duration-200"
                  >
                    Get a Demo
                  </button>
                  <button
                    onclick="window.location.href='/account'"
                    class="px-6 py-3 bg-white text-green-600 border border-green-600 text-lg font-medium rounded-lg shadow-md hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-green-300 transform active:scale-95 transition-all duration-200"
                  >
                    Try Now For Free
                  </button>
                </div>
        ...
        <section class="flex-item" id="functions">
          <div class="grid-container m-auto" style={{ maxWidth: "1110px" }}>
            <div class="grid-item">
              <div class="card_demo">
                <div>
                  <img class="" style=
        ...
        <section class="flex-item" id="intro" style={{ "background-color": "#f2f2f2" }}>
          ...
          <div class="grid-container">
            ...
            <div class="grid-item">
              ...
              <div class="speaker-info notranslate">
                <h3>Yimei Wen</h3>
                <div>Codebase Team Member @ Boston </div>
            ...
            <div class="grid-item">
              ...
              <div class="speaker-info notranslate">
                <h3>Jessica Jiang</h3>
                <div>Active Product Designer @ New York </div>
              </div>
            </div>
            <div class="speaker">
              ...
              <div class="speaker-info notranslate">
                <h3>Winnie Mei</h3>
                <div>Active Product Designer @ Boston</div>
              </div>
